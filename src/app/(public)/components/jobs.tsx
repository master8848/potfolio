...
const features = [
    {
        ...
        description:
            `Worked as app lead for Timesheet
        ...
        <div className="cntColor">
            <div className="max-w-2xl mx-auto py-24 px-4 sm:px-6 sm:py-32 lg:max-w-7xl lg:px-8">
                <div className="max-w-3xl mx-auto text-center">
                    <h2 className="text-3xl font-extrabold tracking-tight  sm:text-4xl">Previous Journeys</h2>
                    <p className="mt-4 ">
                        ...
                        >
                            <div
                                className={classNames(
                                    featureIdx % 2 === 0 ? 'lg:col-start-1' : 'lg:col-start-5 xl:col-start-3',
                                    'mt-6 lg:mt-0 lg:row-start-1 lg:col-span-8 xl:col-span-9'
                                )}
                            >
                                <LinkPreview url={feature.link}>
                                    <a target="_blank" href={feature.link}>
                                        <h3 className="text-lg font-medium underline decoration-wavy decoration-green-600">{feature.name}</h3>
                                        <br />
                            ...
                            >
                                ...
                                <img src={feature.imageSrc} alt={feature.imageAlt} className={cn(" object-cover rounded-lg lg:block  hidden", rotations[featureIdx % rotations.length])} />
                                {/* </div> */}
                            </div>
                        </div>
                    ))}
